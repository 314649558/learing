package com.sxd.app_stm_002.work.sink

import java.util

import com.sxd.app_stm_002.work.utils.{Constants, ESUtils, JsonUtils}
...
class ESKafkaRealTimeSink(config:util.HashMap[String,String]) extends RichSinkFunction[String]{
  ...
  override def invoke(value: String, context: SinkFunction.Context[_]): Unit = {
    val  lst:util.List[String]=new util.ArrayList[String]()
    try {
